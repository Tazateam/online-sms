        ...
        function m(a, c, p) {
            ...
            function E(e, t, n, a, r) {
                ...
                var s, l, u, c = [],
                    ...
                    m = O();
                do {
                    if (!0 === e && M().validPositions[f]) l = (u = !r || !0 !== M().validPositions[f].match.optionality || !0 !== M().validPositions[f].generatedInput && M().validPositions[f].input != p.skipOptionalPartCharacter || M().validPositions[f + 1] !== i ? M().validPositions[f] : D(f, N(f, s, f - 1))).match, s = u.locator.slice(), c.push(!0 === n ? u.input : !1 === n ? l.nativeDef : $(f, l));
                    else {
            ...
            function N(t, n, a) {
                            ...
                            if (o.isGroup && u !== o) {
                                ...
                                if (-1 === E || "string" == typeof E) {
                                    ...
                                    if ("string" == typeof E) _ = E.split(",");
                                        ...
                                        for (w = 0; w < P.matches.length; w++) _.push(w.toString());
                                    if (M().excludes[t]) {
                                    ...
                                    for (var R = !1, N = 0; N < _.length; N++) {
                                        w = parseInt(_[N]), m = [], a = "string" == typeof E && v(c, w, C) || D.slice(), P.matches[w] && l(P.matches[w], [w].concat(s), u) ? o = !0 : 0 === N && (R = !0), x = m.slice(), c = O, m = [];
                ...
                if (t > -1) {
                    if (n === i) {
                        for (var v, k = t - 1;
                            (v = M().validPositions[k] || M().tests[k]) === i && k > -1;) k--;
            ...
            function H(t, n, a, r, o) {
                var s, l, u, c, p, f, m, d = e.extend(!0, {}, M().validPositions),
                    h = !1,
                    g = o !== i ? o : O();
                if (-1 === g && o === i) l = (c = T(s = 0)).alternation;
                    ...
                    var v = [],
                        k = 0;
                    for (p = m; p < O(i, !0) + 1; p++)(f = M().validPositions[p]) && !0 !== f.generatedInput ? v.push(f.input) : p < t && k++, delete M().validPositions[p];
                    for (; M().excludes[m] && M().excludes[m].length < 10;) {
                        ...
                        if (h && n !== i) {
                            var P = O(t) + 1;
                            for (p = m; p < O() + 1; p++)((f = M().validPositions[p]) === i || null == f.match.fn) && p < t + y && y++;
            ...
            function V(t, n, a, r, o, s) {
                ...
                if (e.isFunction(p.preValidation) && !a && !0 !== r && !0 !== s && (m = p.preValidation(I(), c, n, l(t), p, M())), !0 === m) {
                    ...
                    }!1 !== m || !1 === p.keepStatic || null != p.regex && !re(I()) || a || !0 === o || (m = H(c, n, a, r)), !0 === m && (m = {
                        pos: c
                    })
                }
                ...
                if (t.begin > t.end && (s = t.end, l = t.begin), r = r !== i ? r : s, s !== l || p.insertMode && M().validPositions[r] !== i && a === i) {
                    ...
                    for (n && (M().validPositions[r] = e.extend(!0, {}, n), h++, m++, s < l && g++); g <= c; g++) {
                        ...
                        if (v !== i && (g >= l || g >= s && !0 !== v.generatedInput && o(g, u, {
                            ...
                            for (;
                                "" !== T(h).match.def;) {
                                if (!1 === d && u[h] && u[h].match.nativeDef === v.match.nativeDef) M().validPositions[h] = e.extend(!0, {}, u[h]), M().validPositions[h].input = v.input, K(i, h, !0), m = h + 1, f = !0;
                    ...
                    if (t > -1 && M().validPositions[t] === i) {
                        ...
                        if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                            for (var l = 0; l < o.length; l++)
                                if (!0 !== o[l].match.optionality && !0 !== o[l].match.optionalQuantifier && (null === o[l].match.fn || r === i || !1 !== o[l].match.fn.test(r.match.def, M(), t, !0, p)) && (s.push(o[l]), null === o[l].match.fn && (r = o[l]), s.length > 1 && /[0-9a-bA-Z]/.test(s[0].match.def))) return p.placeholder.charAt(t % p.placeholder.length)
                    }
                    return n.def
                }
                ...
                Y = {
                    keydownEvent: function(t) {
                        var n = this,
                            ...
                            a = t.keyCode,
                            r = ne(n);
                        if (a === u.keyCode.BACKSPACE || a === u.keyCode.DELETE || l && a === u.keyCode.BACKSPACE_SAFARI || t.ctrlKey && a === u.keyCode.X && !f("cut")) t.preventDefault(), oe(n, a, r), W(n, I(!0), M().p, t, n.inputmask._valueGet() !== I().join(""));
                    ...
                    pasteEvent: function(n) {
                        ...
                        if (l === (b ? G().reverse() : G()).slice(0, s.begin).join("") && (l = ""), u === (b ? G().reverse() : G()).slice(s.end).join("") && (u = ""), b && (i = l, l = u, u = i), t.clipboardData && t.clipboardData.getData) o = l + t.clipboardData.getData("Text") + u;
                        else {
            ...
            function X(t, n, a, r, o) {
                ...
                if (w(), a || !0 === p.autoUnmask) c = q(c);
                    ...
                    if (r !== i)
                        if (M().validPositions[n] === i && s[n] === $(n) && z(n, !0) && !1 === V(n, s[n], !0, i, i, !0)) M().p++;
                        else {
                ...
                case "mask":
                    ! function(t) {
                        ...
                        if (!1 !== a && (h = e(y = t), -1 === (g = y !== i ? y.maxLength : i) && (g = i), !0 === p.colorMask && se(y), r && ("inputmode" in y && (y.inputmode = p.inputmode, y.setAttribute("inputmode", p.inputmode)), !0 === p.disablePredictiveText && ("autocorrect" in y ? y.autocorrect = !1 : (!0 !== p.colorMask && se(y), y.type = "password"))), !0 === a && (J.on(y, "submit", Y.submitEvent), J.on(y, "reset", Y.resetEvent), J.on(y, "blur", Y.blurEvent), J.on(y, "focus", Y.focusEvent), !0 !== p.colorMask && (J.on(y, "click", Y.clickEvent), J.on(y, "mouseleave", Y.mouseleaveEvent), J.on(y, "mouseenter", Y.mouseenterEvent)), J.on(y, "dblclick", Y.dblclickEvent), J.on(y, "paste", Y.pasteEvent), J.on(y, "dragdrop", Y.pasteEvent), J.on(y, "drop", Y.pasteEvent), J.on(y, "cut", Y.cutEvent), J.on(y, "complete", p.oncomplete), J.on(y, "incomplete", p.onincomplete), J.on(y, "cleared", p.oncleared), r || !0 === p.inputEventOnly ? y.removeAttribute("maxLength") : (J.on(y, "keydown", Y.keydownEvent), J.on(y, "keypress", Y.keypressEvent)), J.on(y, "compositionstart", e.noop), J.on(y, "compositionupdate", e.noop), J.on(y, "compositionend", e.noop), J.on(y, "keyup", e.noop), J.on(y, "input", Y.inputFallBackEvent), J.on(y, "beforeinput", e.noop)), J.on(y, "setvalue", Y.setValueEvent), d = G().join(""), "" !== y.inputmask._valueGet(!0) || !1 === p.clearMaskOnLostFocus || n.activeElement === y)) {
                            ...
                            var l = I().slice();
                            d = l.join(""), !1 === re(l) && p.clearIncomplete && w(), p.clearMaskOnLostFocus && n.activeElement !== y && (-1 === O() ? l = [] : ae(l)), (!1 === p.clearMaskOnLostFocus || p.showMaskOnFocus && n.activeElement === y || "" !== y.inputmask._valueGet(!0)) && W(y, l), n.activeElement === y && ne(y, q(O()))
                        }
                    }(y);
                    break;
                case "format":
