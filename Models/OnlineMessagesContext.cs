...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contacts__5C6625BBD2FC9740");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.FriendUserId }).HasName("PK__Friends__11BD2B9C3544A1CD");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__tmp_ms_x__C87C037CEF7594CE");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Services__C51BB0EA8C415959");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC500D39F5");

            entity.HasIndex(e => e.MobileNumber, "UQ__Users__250375B1053EC6DF").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4A24A9927").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053424DC1B8D").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserProf__1788CCAC20900014");
        ...
        {
            entity.HasKey(e => e.UserServiceId).HasName("PK__UserServ__C737CAF91EE6A83D");
